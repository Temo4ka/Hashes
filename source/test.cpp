...
int test_diagrams(HashFunc_t hashFuncs[HASH_FUNC_NUM], Text *text, const char* outputFileName, size_t HashSize) {
    catchNullptr(     text     );
...
int test_speed(HashFunc_t hash, Text *text) {
    ...
    return EXIT_SUCCESS;
>>>>>>> 4a0a211e26fa9b71d07de0bc5cf7e43c6228120f:test.cpp
}