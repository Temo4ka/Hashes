...
| GnuHash | 262 ± 8.7 | 1x |
| GnuHashAsm | 134 ± 4.1 | 1.96x |
| Crc32Hash | 252 ± 4.8 |  1.03x |
| FastCrc32Hash| 162 ± 9.9 | 1.64x |
...
4. Отдельный пункт хочу выделить для SIMD операции, так как векторные операции в разы ускоряют программу.
5. К моему удивлению, функция переписанная на MASM64 смогла оптимизировать функцию даже больше, чем векторные операции. 
